<template>
  <div class="relative w-20 h-20 shrink-0">
    <!-- Das Logo -->
    <div class="w-full h-full flex items-center justify-center rounded-2xl border border-slate-100 shadow-sm">
      <TeamLogo v-if="md.homeTeam" :team-name="md.homeTeam" size-class="w-full h-full object-contain p-3"
        :theme-team-name="md.home ? md.homeTeam : undefined" fallback-class="" />
    </div>
