    ...
    <div :id="id" class="relative flex flex-col bg-slate-50 text-slate-900 antialiased select-none"
        ...
        <div class="absolute inset-0 pointer-events-none overflow-hidden">
            <img src="/image.png" alt=""
                class="absolute inset-0 m-auto h-[1080px] w-[1080px] object-contain grayscale" />
            <div class="absolute inset-0 m-auto h-[1080px] w-[1080px] mix-blend-color opacity-70" :style="{
