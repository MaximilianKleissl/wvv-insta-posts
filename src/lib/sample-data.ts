...
const sampleDataModules = import.meta.glob<{ default: unknown }>("./sample-data/*.json", { eager: true });
...
export const SAMPLE_SEASON_METADATA_JSON = JSON.stringify({ season: SAMPLE_SEASON_DATA.season, club: SAMPLE_SEASON_DATA.club }, null, 2);
